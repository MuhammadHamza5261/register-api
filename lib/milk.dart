import 'package:copyproject/list_label.dart';
         ...
         Container(
           child: Column(
             children: [
               ///1st card
               Container(
                 margin: EdgeInsets.only(left: 13.0,top: 20.0,right: 13.0,),
                 width: width*0.92,
                 height: height*0.09,
                 child: Card(
                   elevation: 2.0,
                         ...
                         child: Row(
                           children: [
                             ...
                             Container(
                               ...
                               child: ImageIcon(
                                 AssetImage('Assests/Images/b.png'),
               ...
               Container(
                 margin: EdgeInsets.only(top: 10.0,),
                 child: Center(
                   child: Text('Showing prices from biggest stores in Lahore',
                     style: TextStyle(
                       fontSize: 12.0,
                       fontWeight: FontWeight.w400,
