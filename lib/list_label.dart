...
import 'package:copyproject/mylist.dart';
import 'package:copyproject/qr_code.dart';
      ...
      items: [
              ...
              child: InkWell(
                ...
                child: Row(
                  ...
                  children:[
                    Container(
                      child: ImageIcon(
                        AssetImage('Assests/Images/Vector (2).png'),
                      ),
                    ),
                    Container(
                      margin: EdgeInsets.only(left: 10.0,),
        ...
        PopupMenuItem(
          child: Row(
            ...
            children:[
              Container(
                child: Icon(Icons.share, color: Color.fromRGBO(52,107,33,1),),
              ),
              Container(
                margin: EdgeInsets.only(left: 10.0,),
                child: InkWell(
             ...
             children: [
               ...
               Container(
                 child: Row(
                   ...
                   children: [
                     Container(
                       child: Icon(Icons.close,color: Color.fromRGBO(52,107,33,1),),
                     ),
                   ],
                 ),
               ),
               ...
               Container(
                 ...
                 child: ElevatedButton(
                   ...
                   onPressed: (){
                     ...
                     Navigator.of(context).push(MaterialPageRoute(builder: (context) => qr_code()));
                   },
                   child: Text('Continue',
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        //           },
        //           child: ImageIcon(
        //             AssetImage('Assests/Images/Vector (1).png'),
        //
        //
        //           ),
        //         ),
        ...
        Container(
          child: Column(
            children: [
                              ...
                              children: [
                                Container(
                                  child: InkWell(
                                    ...
                                    Container(
                                         margin: EdgeInsets.only(left: 127.0,),
                                        child: InkWell(
                                         onTap: (){
                                          setState(() {
              ...
              //             },
              //             child: ImageIcon(
              //               AssetImage('Assests/Images/Vector (3).png'),
              //
              //
              //             ),
              //           ),
                                 ...
                                 child: Container(
                                   ...
                                   child: Stack(
                                     children:[
                                       ...
                                       Container(
                                         margin: EdgeInsets.only(left: 99.0,top: 29.0),
                                         width: width*0.07,
                                         height: height*0.023,
                                         child: Card(
                                           color: Color.fromRGBO(52,107,33,1),
                                 ...
                                 child: Container(
                                   ...
                                   child: Stack(
                                     children:[
                                       ...
                                       Container(
                                         margin: EdgeInsets.only(left: 28.5,top: 29.0),
                                         width: width*0.07,
                                         height: height*0.023,
                                         child: Card(
                                           color:  Color.fromRGBO(52,107,33,1),
                                 ...
                                 child: Container(
                                   ...
                                   child: Stack(
                                     children:[
                                       ...
                                       Container(
                                         margin: EdgeInsets.only(left: 90.0,top: 29.0),
                                         width: width*0.07,
                                         height: height*0.023,
                                         child: Card(
                                           color: Color.fromRGBO(52,107,33,1),
                                 ...
                                 child: Container(
                                   ...
                                   child: Stack(
                                     children:[
                                       ...
                                       Container(
                                         margin: EdgeInsets.only(left: 20.0,top: 28.0),
                                         width: width*0.095,
                                         height: height*0.023,
                                         child: Card(
                                           color:  Color.fromRGBO(52,107,33,1),
                  ...
                  child: Container(
                    child: Center(
                      child: Column(
                        children: [
                          Container(
                            child: Image.asset('Assests/Images/Frame (2).png'),
                          ),
                          SizedBox(
                            height: 7.0,
                          ),
                          Container(
                            child: Text('Add items to show here',
                              style: TextStyle(
                                  fontSize: 13.0,
                                  fontWeight: FontWeight.w400,
                                  color: Colors.grey
                ...
                child: Container(
                  ...
                  child: Card(
                    ...
                    child: Row(
                      children: [
                        Container(
                          margin: EdgeInsets.only(left: 18.0,top: 3.0,),
                          child: Image.asset('Assests/Images/Group 13.png'),
                        ),
                       Container(
                        ...
                        Container(
                          ...
                          child: IconButton(onPressed: () {
                                    ...
                                    height: 220,
                                      child: Column(
                                        children: [
                                                ...
                                                Container(
                                                  ...
                                                  child: InkWell(
                                                    onTap: (){
                                                      ...
                                                      child: const Icon(Icons.close, color: Color.fromRGBO(52,107,33,1),)),
                                                ),
                                          ...
                                          InkWell(
                                            onTap: (){
                                              Navigator.of(context).push(MaterialPageRoute(builder: (context) => milkscreen()));
                            ...
                            icon: Icon(Icons.chevron_right_outlined, color: Color.fromRGBO(52,107,33,1),size: 30.0,),
